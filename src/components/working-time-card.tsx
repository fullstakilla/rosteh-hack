...
export function WorkingTimeCard() {
  ...
  return (
    <div className="border-2 rounded-lg overflow-hidden border-gray-200 w-full">
      {/* Заголовок карточки */}
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <label className="flex-1">
            <span className="block text-gray-700 mb-1">Начальная дата:</span>
            <Input
              type="date"
              value={startDate}
          ...
          <label className="flex-1">
            <span className="block text-gray-700 mb-1">Конечная дата:</span>
            <Input
              type="date"
              value={endDate}
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-1 p-6 bg-gray-50 rounded-lg flex flex-col items-center justify-center gap-4">
            {/* Иконка часов */}
            ...
            <div className="text-center">
              <h3 className="text-xl font-semibold mb-2">Общее время работы</h3>{" "}
              {/* Увеличил размер текста */}
              <p className="text-4xl font-bold text-gray-800">
                {totalWorkingTime} часов
              </p>
              <p className="text-sm text-gray-500 mt-2">За выбранный период</p>
            </div>
          </div>
